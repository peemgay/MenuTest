...
class MenuViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
    ...
    private func setUpAnimals() {
        // CATS
        animalArray.append(Animal(name: "Amber", category: .cat, image:"ก๋วยเตี๋ยวต้มยำ"))
        animalArray.append(Animal(name: "James", category: .cat, image:"ก๋วยเตี๋ยวต้มยำ"))
        animalArray.append(Animal(name: "Peter", category: .cat, image:"ก๋วยเตี๋ยวต้มยำ"))
        // DOGS
        animalArray.append(Animal(name: "Haywood", category: .dog, image:"ก๋วยเตี๋ยวต้มยำ"))
        animalArray.append(Animal(name: "Shell", category: .dog, image:"ก๋วยเตี๋ยวต้มยำ"))
        animalArray.append(Animal(name: "James", category: .dog, image:"ก๋วยเตี๋ยวต้มยำ"))
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.img.image = UIImage(named:currentAnimalArray[indexPath.row].image)
        return cell
    }
